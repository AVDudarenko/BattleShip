...
class MenuScreen(private val game: BattleShipGame) : Stage(ScreenViewport()), Screen {
	...
	init {
		...
		startButton.setPosition(
			(Gdx.graphics.width - startButton.width) / 2,
			(Gdx.graphics.height - startButton.height) / 2
		)
