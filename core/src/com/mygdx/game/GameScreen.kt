...
class GameScreen : InputAdapter() {
	...
	private lateinit var autoButton: TextButton

	private val screenWidth = Gdx.graphics.width.toFloat()
	private val screenHeight = Gdx.graphics.height.toFloat()

	private val gridSize = 10
	private val cellSize = screenWidth / (gridSize + 1) // оставляем место для координат
...
//		skin = Skin(Gdx.files.internal("uiskin.json"))
		...
		autoButton = TextButton("Auto", buttonStyle)
